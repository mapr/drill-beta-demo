...
echo "script maprdb.customers.sh"
...
echo "Running ImportTsv for customers.all.csv for maprdb"
sudo -u mapr hbase org.apache.hadoop.hbase.mapreduce.ImportTsv -Dimporttsv.separator=, \
...
echo "Finished running ImportTsv on customers.all.csv for maprdb"
